...
//        Navigator.pop(context);
  ...
  updateScreens(screen, count) async {
    final updateScreensResponse = await http.post(Uri.parse(APIData.updateScreensApi), body: {
      "macaddress": '$ip',
      "screen": '$screen',
      "count": '$count',
    }, headers: {
  ...
  screenLogout() async{
    Wakelock.disable();
    final screenLogOutResponse = await http.post(Uri.parse(APIData.screenLogOutApi), body: {
